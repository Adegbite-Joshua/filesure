...
export default function Home() {
  ...
  return (
    <main className="relative w-full">
      ...
      {/* Hero Section */}
      <section className="bg-slate-100 pt-40 relative overflow-hidden">
        <div className="flex flex-col p-5 md:p-28 relative z-10">
          ...
          <Form isDiscussionForm={false} buttonText="Get consultation" handleSubmit={handleConsultationSubmit} />
        </div>
      ...
      <section className="bg-slate-100 p-5 md:p-28">
      ...
      {/* Discuss Your Project Component */}
      <section className="flex flex-col md:flex-row items-center justify-center bg-gradient-to-r from-yellow-500 via-yellow-500  to-green-700 p-5 md:px-20 md:p-10">
        ...
        <div className="w-full md:w-3/6">
          ...
          <Form isDiscussionForm={true} buttonText="Discuss the project" handleSubmit={handleDiscussionSubmit} />
        </div>
      </section>

      {/* Application Development Stages */}
      <section className="container p-5 md:p-12">
      ...
      {/* Our Team Section */}
      <section className="bg-slate-100 grid grid-cols-1 md:grid-cols-2 gap-3 p-5 md:p-20">
        <div>
